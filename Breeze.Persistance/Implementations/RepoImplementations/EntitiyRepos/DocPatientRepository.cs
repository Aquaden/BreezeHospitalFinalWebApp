...
{
    public class DocPatientRepository : GenericRepository<DoctorPatients>, IDocPatientRepository
    {
        public DocPatientRepository(AppDbContext appDbContext) : base(appDbContext)
        {
        }
    }
}
